...
void readBlock(){
    ifstream file("/Users/gongshukai/Desktop/SCHOOL WORK/SOPHOMORE SEM1/DATA STRUCTURE  & ALGORITHM /SLIDES & HOMEWORK & LAB/LAB/Dec.1_Lab/dataset.1/block_part1.csv");
    if (!file) {
    ...
    cout << "Time of Block Information Reading: " <<(double)(endTime - startTime) / CLOCKS_PER_SEC << "s" << endl;
    cout << "Block Number: "<< count << endl;
    cout << endl;
}

void readTransactions(string fileName){
    fileName = "/Users/gongshukai/Desktop/SCHOOL WORK/SOPHOMORE SEM1/DATA STRUCTURE  & ALGORITHM /SLIDES & HOMEWORK & LAB/LAB/Dec.1_Lab/dataset.1/"+ fileName +".csv";
    ...
    file.close();
    clock_t endTime = clock();
    cout << "Time of Transaction Reading: " <<(double)(endTime - startTime) / CLOCKS_PER_SEC << "s" << endl;
